...
function setupTHREE() {
  ...
  let guiShadow = gui.addFolder("light-shadow")
  guiShadow.add(tLight.light.shadow.mapSize, "width", 512, 1024).step(1);
  guiShadow.add(tLight.light.shadow.mapSize, "height", 512, 1024).step(1);
}
