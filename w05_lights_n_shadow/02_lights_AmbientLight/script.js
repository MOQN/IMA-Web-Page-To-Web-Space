...
function setupTHREE() {
  ...
  let guiLight = gui.addFolder("ambiLightColor");
  guiLight.add(ambiLight.color, "r", 0.0, 1.0);
  guiLight.add(ambiLight.color, "g", 0.0, 1.0);
  guiLight.add(ambiLight.color, "b", 0.0, 1.0);
}
