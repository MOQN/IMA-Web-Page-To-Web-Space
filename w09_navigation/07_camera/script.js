...
function updateTHREE() {
  camera.position.x = cos(frame * 0.010) * 30;
  camera.position.y = sin(frame * 0.005) * 10;

  camera.rotation.y = cos(frame * 0.010) * PI / 24;
  camera.rotation.z = cos(frame * 0.007) * PI / 24;
}
